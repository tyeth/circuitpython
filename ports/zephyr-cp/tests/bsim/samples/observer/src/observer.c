...
static int scan_start(void) {
    /* 30 ms continuous active scanning. Duplicate filtering is disabled so
     * that updated advertisements from the same device (e.g. when user
     * code replaces the workflow advert) are reported again.
     */
