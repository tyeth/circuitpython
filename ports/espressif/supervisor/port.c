...
// Cap what the GC may take so CIRCUITPY_ESP_RADIO_HEAP_RESERVE of the IDF heap
// stays available to the radio stacks while one is enabled (see mpconfigport.h).
