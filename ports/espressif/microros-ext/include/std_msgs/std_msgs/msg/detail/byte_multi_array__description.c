...
std_msgs__msg__ByteMultiArray__get_type_hash(
...
static char std_msgs__msg__ByteMultiArray__FIELD_NAME__layout[] = "layout";
static char std_msgs__msg__ByteMultiArray__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field std_msgs__msg__ByteMultiArray__FIELDS[] = {
  {
    {std_msgs__msg__ByteMultiArray__FIELD_NAME__layout, 6, 6},
    {
  ...
  {
    {std_msgs__msg__ByteMultiArray__FIELD_NAME__data, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription std_msgs__msg__ByteMultiArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
std_msgs__msg__ByteMultiArray__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {std_msgs__msg__ByteMultiArray__FIELDS, 2, 2},
    },
    {std_msgs__msg__ByteMultiArray__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
...
std_msgs__msg__ByteMultiArray__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
std_msgs__msg__ByteMultiArray__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *std_msgs__msg__ByteMultiArray__get_individual_type_description_source(NULL),
