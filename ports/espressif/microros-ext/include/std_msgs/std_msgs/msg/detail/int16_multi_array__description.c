...
std_msgs__msg__Int16MultiArray__get_type_hash(
...
static char std_msgs__msg__Int16MultiArray__TYPE_NAME[] = "std_msgs/msg/Int16MultiArray";
...
static char std_msgs__msg__Int16MultiArray__FIELD_NAME__layout[] = "layout";
static char std_msgs__msg__Int16MultiArray__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field std_msgs__msg__Int16MultiArray__FIELDS[] = {
  {
    {std_msgs__msg__Int16MultiArray__FIELD_NAME__layout, 6, 6},
    {
  ...
  {
    {std_msgs__msg__Int16MultiArray__FIELD_NAME__data, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription std_msgs__msg__Int16MultiArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
std_msgs__msg__Int16MultiArray__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {std_msgs__msg__Int16MultiArray__TYPE_NAME, 28, 28},
      {std_msgs__msg__Int16MultiArray__FIELDS, 2, 2},
    },
    {std_msgs__msg__Int16MultiArray__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
...
std_msgs__msg__Int16MultiArray__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *std_msgs__msg__Int16MultiArray__get_individual_type_description_source(NULL),
