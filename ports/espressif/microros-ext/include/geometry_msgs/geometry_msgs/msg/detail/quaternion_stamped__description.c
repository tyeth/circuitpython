...
static char geometry_msgs__msg__QuaternionStamped__FIELD_NAME__header[] = "header";
static char geometry_msgs__msg__QuaternionStamped__FIELD_NAME__quaternion[] = "quaternion";

static rosidl_runtime_c__type_description__Field geometry_msgs__msg__QuaternionStamped__FIELDS[] = {
  {
    {geometry_msgs__msg__QuaternionStamped__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {geometry_msgs__msg__QuaternionStamped__FIELD_NAME__quaternion, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription geometry_msgs__msg__QuaternionStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {geometry_msgs__msg__QuaternionStamped__FIELDS, 2, 2},
    },
    {geometry_msgs__msg__QuaternionStamped__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
...
geometry_msgs__msg__QuaternionStamped__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *geometry_msgs__msg__QuaternionStamped__get_individual_type_description_source(NULL),
