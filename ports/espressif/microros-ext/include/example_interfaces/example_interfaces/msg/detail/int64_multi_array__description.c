...
example_interfaces__msg__Int64MultiArray__get_type_hash(
...
static char example_interfaces__msg__Int64MultiArray__TYPE_NAME[] = "example_interfaces/msg/Int64MultiArray";
...
static char example_interfaces__msg__Int64MultiArray__FIELD_NAME__layout[] = "layout";
static char example_interfaces__msg__Int64MultiArray__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field example_interfaces__msg__Int64MultiArray__FIELDS[] = {
  {
    {example_interfaces__msg__Int64MultiArray__FIELD_NAME__layout, 6, 6},
    {
  ...
  {
    {example_interfaces__msg__Int64MultiArray__FIELD_NAME__data, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription example_interfaces__msg__Int64MultiArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {example_interfaces__msg__Int64MultiArray__TYPE_NAME, 38, 38},
      {example_interfaces__msg__Int64MultiArray__FIELDS, 2, 2},
    },
    {example_interfaces__msg__Int64MultiArray__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
...
example_interfaces__msg__Int64MultiArray__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *example_interfaces__msg__Int64MultiArray__get_individual_type_description_source(NULL),
