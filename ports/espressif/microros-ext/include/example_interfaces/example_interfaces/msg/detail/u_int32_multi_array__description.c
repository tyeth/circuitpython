  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x06, 0x83, 0x17, 0x6c, 0x52, 0x3a, 0x11, 0x6c,
      0x76, 0x14, 0x1c, 0x6d, 0x4a, 0xbd, 0x15, 0x0d,
      0xbf, 0xf4, 0x92, 0xb7, 0x21, 0x85, 0xf1, 0x26,
      0x0c, 0xe3, 0x8a, 0x18, 0xa3, 0x5a, 0xaf, 0xcf,
    }};
  return &hash;
}
...
static char example_interfaces__msg__UInt32MultiArray__TYPE_NAME[] = "example_interfaces/msg/UInt32MultiArray";
...
static char example_interfaces__msg__UInt32MultiArray__FIELD_NAME__layout[] = "layout";
static char example_interfaces__msg__UInt32MultiArray__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field example_interfaces__msg__UInt32MultiArray__FIELDS[] = {
  {
    {example_interfaces__msg__UInt32MultiArray__FIELD_NAME__layout, 6, 6},
    {
  ...
  {
    {example_interfaces__msg__UInt32MultiArray__FIELD_NAME__data, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription example_interfaces__msg__UInt32MultiArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {example_interfaces__msg__UInt32MultiArray__TYPE_NAME, 39, 39},
      {example_interfaces__msg__UInt32MultiArray__FIELDS, 2, 2},
    },
    {example_interfaces__msg__UInt32MultiArray__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
...
example_interfaces__msg__UInt32MultiArray__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *example_interfaces__msg__UInt32MultiArray__get_individual_type_description_source(NULL),
